    ...
    *,
    ...
    lines.extend(
        [
            ...
            "manifest, README, checklist, and copy index are private operator",
            "metadata. Send only the numbered `.txt` file contents.",
            "",
    ...
    if outreach.get("send_copy_batch_state") == "ready" and batch_dir:
        lines.extend(
            [
                ...
                "indexes, target labels, tracker commands, or operator metadata.",
                "",
            ]
        )
    else:
