...
class MakeValidationTargetsTests(unittest.TestCase):
    ...
    def test_make_help_describes_validation_status_outputs(self) -> None:
        ...
        self.assertIn("make validation-working-product-handoff-save", completed.stdout)
        self.assertIn("ignored private working-product handoff", completed.stdout)
        ...
        self.assertIn("shorter contact-form copy files", completed.stdout)
        self.assertIn("make validation-contact-form-copy-check", completed.stdout)
        self.assertIn("Verify existing contact-form copy files are outbound-only", completed.stdout)
