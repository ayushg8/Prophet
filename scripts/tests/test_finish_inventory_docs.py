...
class FinishInventoryDocsTests(unittest.TestCase):
    ...
    def test_completion_audit_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("6bd27c6a9d149eaf62c35c159468240a0daac770", audit)
        self.assertIn("actions/runs/25670236106", audit)
        self.assertIn("Add pre-send guard to validation send artifacts", audit)
        self.assertIn("Current repo head after audit-only handoff commits", audit)
        self.assertIn("97cfcfb3236e071ff325985970123c89b984e11f", audit)
        self.assertIn("actions/runs/25670716101", audit)
        self.assertIn("Put pre-send guard first in completion audit", audit)
        self.assertIn("make pilot-ready-check DATE=2026-05-11", audit)
        self.assertIn("make console-live-check", audit)
        self.assertIn("make release-hygiene", audit)
        self.assertIn("http://127.0.0.1:5173/", audit)
        self.assertIn("http://127.0.0.1:8787/api/readiness", audit)
    ...
    def test_finish_inventory_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("6bd27c6a9d149eaf62c35c159468240a0daac770", inventory)
        self.assertIn("actions/runs/25670236106", inventory)
        self.assertIn("Add pre-send guard to validation send artifacts", inventory)
        self.assertIn("Current repo head after audit-only handoff commits", inventory)
        self.assertIn("97cfcfb3236e071ff325985970123c89b984e11f", inventory)
        self.assertIn("actions/runs/25670716101", inventory)
        self.assertIn("Put pre-send guard first in completion audit", inventory)
