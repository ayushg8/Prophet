...
class FinishInventoryDocsTests(unittest.TestCase):
    ...
    def test_completion_audit_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("1003f32d9f7381a4df7cde3796c2a02ab431d170", audit)
        self.assertIn("actions/runs/25685871927", audit)
        self.assertIn("Add safe SBOM demo wrapper", audit)
        self.assertIn("make release-tag-preflight DATE=2026-05-11", audit)
        self.assertIn("validation-pre-send-check-all DATE=2026-05-11", audit)
        self.assertIn("make validation-send-copy-check DATE=2026-05-11", audit)
        self.assertIn("make validation-contact-form-copy-check DATE=2026-05-11", audit)
    ...
    def test_finish_inventory_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("1003f32d9f7381a4df7cde3796c2a02ab431d170", inventory)
        self.assertIn("actions/runs/25685871927", inventory)
        self.assertIn("Add safe SBOM demo wrapper", inventory)
        self.assertIn("make release-tag-preflight DATE=2026-05-11", inventory)
        self.assertIn("full-batch pre-send checking", inventory)
        self.assertIn("make validation-send-copy-check DATE=2026-05-11", inventory)
        self.assertIn("make validation-contact-form-copy-check DATE=2026-05-11", inventory)
