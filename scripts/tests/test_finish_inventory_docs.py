...
class FinishInventoryDocsTests(unittest.TestCase):
    ...
    def test_completion_audit_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("6eb85ebe72a241040cb47bf20dddbebb2ae9c13a", audit)
        self.assertIn("actions/runs/25687002226", audit)
        self.assertIn("Add supply-chain review artifact checker", audit)
        self.assertIn("make supply-chain-sbom DATE=2026-05-11", audit)
        self.assertIn("make supply-chain-sbom-check DATE=2026-05-11", audit)
    ...
    def test_finish_inventory_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("6eb85ebe72a241040cb47bf20dddbebb2ae9c13a", inventory)
        self.assertIn("actions/runs/25687002226", inventory)
        self.assertIn("Add supply-chain review artifact checker", inventory)
        self.assertIn("make supply-chain-sbom DATE=2026-05-11", inventory)
        self.assertIn("make supply-chain-sbom-check DATE=2026-05-11", inventory)
